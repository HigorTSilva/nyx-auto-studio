...
export function BeforeAfter() {
  ...
  // Só reseta (pra tocar de novo) se a seção sair por baixo, ou seja, o
  // usuário rolou pra cima e deixou ela inteira pra trás. Saindo por cima,
  // rolando pra baixo normalmente, o estado não muda.
  useEffect(() => {

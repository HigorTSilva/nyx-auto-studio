...
export function DropletIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} {...props}>
      <path d="M12 3c3.6 4.2 6 7.6 6 10.5a6 6 0 1 1-12 0C6 10.6 8.4 7.2 12 3Z" />
    </svg>
  );
}
...
export function ShieldIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} {...props}>
      <path d="M12 3.5 19 6.5v5c0 4.5-3 7.8-7 9-4-1.2-7-4.5-7-9v-5Z" />
...
export function MotorcycleIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} {...props}>
      ...
      <path d="M5.5 17 10 9h4l1.5 3.5H19M10 9 8.5 6H6M13 12.5l2.5 4.5" />
    </svg>
  );
}

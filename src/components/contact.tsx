    ...
    <SectionExit>
      <section id="contato" className="relative overflow-hidden bg-onyx px-6 py-24 sm:px-10 lg:px-16">
        <Logo
          variant="mono"
          aria-hidden="true"
          className="pointer-events-none absolute -right-24 top-1/2 h-[420px] w-[420px] -translate-y-1/2 text-accent/[0.06] sm:h-[560px] sm:w-[560px]"
        />
        ...
        <div className="relative mx-auto grid max-w-6xl gap-16 lg:grid-cols-2">
          ...
          >
            ...
            >
              ...
              <div className="min-h-[280px] bg-[radial-gradient(circle_at_top,rgba(52,163,153,0.06),transparent_60%)] p-5">
                <div className="relative max-w-[85%] rounded-2xl rounded-tl-sm border border-accent-light/25 bg-accent-light/10 p-4 text-sm leading-relaxed text-foreground">
                  ...
                  <span className="ml-0.5 inline-block h-3.5 w-[2px] animate-pulse bg-accent-light align-middle" />
                </div>
